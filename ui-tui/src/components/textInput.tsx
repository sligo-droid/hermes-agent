...
export const shouldBufferInputAsPaste = (text: string, bracketed: boolean) => bracketed || text.includes('\n')
export const shouldInsertPlainBurst = (text: string, bracketed: boolean) =>
  !bracketed && text.length > 1 && !text.includes('\n') && PRINTABLE.test(text)
