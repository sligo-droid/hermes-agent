...
def load_cli_config() -> Dict[str, Any]:
    ...
    defaults = {
        ...
        "agent": {
            "max_turns": 25,  # Default max tool-calling iterations
            "codex_app_server_turn_timeout": 600,  # Seconds per Codex app-server turn
            "verbose": False,
            "system_prompt": "",
...
class HermesCLI:
    ...
    def __init__(
        ...
        Args:
            ...
            max_turns: Maximum tool-calling iterations (default: 25)
    ...
    def chat(self, message, images: list = None) -> Optional[str]:
        ...
        try:
            ...
            if result and not result.get("completed") and not result.get("interrupted"):
                ...
                if _api_calls >= getattr(self.agent, "max_iterations", 25):
                    _max_iter = getattr(self.agent, "max_iterations", 25)
                    _cprint(
