...
_DISCORD_READ_ONLY_PROMPT = (
    ...
    "read-only delegation tools. Omit delegate_task's model_tier to inherit "
    "this route tier (Sol/low by default); use model_tier='trivial' for a Luna/medium exploratory "
    "child or model_tier='basic' for Luna/xhigh when that subtask benefits from "
    "deeper independent exploration. Durable changes are structurally blocked: do "
