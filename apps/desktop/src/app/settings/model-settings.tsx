...
// Reuse the composer's effort labels. `none` is handled separately as thinking off.
const effortLabelKey = (value: Exclude<(typeof EFFORT_VALUES)[number], 'none'>) => value
