...
describe('approval mode statusbar item', () => {
  ...
  it('writes configured Smart mode through the gateway and updates its shared trigger label', async () => {
    ...
    await waitFor(() => {
      expect(requestGateway).toHaveBeenCalledWith('config.set', { key: 'approvals.mode', value: 'smart' })
