...
- [references/index.md](references/index.md) — curated FSDP reference index.
- [references/other.md](references/other.md) — additional generated PyTorch distributed/FSDP notes.
- [references/full-guide.md](references/full-guide.md) — archived full generated guide from official documentation; load for API lookup or rare edge cases.
