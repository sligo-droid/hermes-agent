...
- A long-running process (Hermes gateway, daemon, or child worker) misbehaves and you can't restart it
...
For long-lived processes: Hermes gateway, a daemon, or a process that's already misbehaving and can't be restarted clean.
