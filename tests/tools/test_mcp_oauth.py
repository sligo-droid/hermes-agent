...
class TestRedirectHandlerSshHint:
    ...
    def test_redirect_handler_closure_ignores_stale_global_port(self, monkeypatch, capsys):
        """The per-flow callback port must not read stale module state."""
        import tools.mcp_oauth as mco
        ...
        handler = _make_redirect_handler(49299)
        self._run(handler(
