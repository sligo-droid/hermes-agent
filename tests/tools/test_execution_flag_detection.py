...
@pytest.mark.parametrize(
    ...
    [
        ...
        # The attached long-option spelling is accepted by both GNU sort and
        # uutils sort.  GNU also accepts a separate leading-dash operand; that
        # spelling remains covered conservatively by the detector tests below.
