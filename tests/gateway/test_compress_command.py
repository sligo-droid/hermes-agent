...
async def test_compress_command_appends_warning_when_compression_aborts():
    """When the auxiliary summariser fails and compression aborts, /compress
    must append a visible warning that no messages were dropped."""
    history = _make_history()
    ...
    # abort behavior is no silent data loss.
