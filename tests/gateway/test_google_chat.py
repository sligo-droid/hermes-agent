...
class TestEnvConfigLoading:
    ...
    def test_http_events_enable_without_pubsub(self, monkeypatch):
        ...
        assert (
            cfg.platforms[Platform.GOOGLE_CHAT].extra["http_events_url"]
            == "https://example.test/google-chat/events"
        )
        assert (
            cfg.platforms[Platform.GOOGLE_CHAT].extra["http_events_audience"]
            == "https://callback.example.test/events"
        )
        assert (
            cfg.platforms[Platform.GOOGLE_CHAT].extra[
