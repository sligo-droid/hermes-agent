...
| Mistral TTS + voice transcription | [Mistral](https://console.mistral.ai/) | Temporarily disabled while `mistralai` is quarantined; `MISTRAL_API_KEY` is not used until re-enabled |
