...
- [references/full-guide.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/humanizer/references/full-guide.md) — archived full guide with extensive AI-writing pattern catalog, before/after examples, and voice-matching heuristics.
