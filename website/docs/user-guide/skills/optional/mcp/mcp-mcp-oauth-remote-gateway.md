...
- GitHub Copilot MCP through the generic DCR path: GitHub uses a pre-registered
  ...
  [Troubleshooting, security, and provider variants](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mcp/mcp-oauth-remote-gateway/references/troubleshooting-and-security.md).
...
- Read [Manual OAuth bootstrap](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mcp/mcp-oauth-remote-gateway/references/manual-oauth-flow.md) completely
...
[Manual OAuth bootstrap](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mcp/mcp-oauth-remote-gateway/references/manual-oauth-flow.md#dashboard-first).
...
Read [Manual OAuth bootstrap](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mcp/mcp-oauth-remote-gateway/references/manual-oauth-flow.md#native-tty-fallbacks)
...
Follow [Manual OAuth bootstrap](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mcp/mcp-oauth-remote-gateway/references/manual-oauth-flow.md#manual-bootstrap-procedure)
in order:
...
Read [Troubleshooting, security, and provider variants](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mcp/mcp-oauth-remote-gateway/references/troubleshooting-and-security.md)
...
|---|---|
| [Manual OAuth bootstrap](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mcp/mcp-oauth-remote-gateway/references/manual-oauth-flow.md) | Starting dashboard discovery, native TTY recovery, or a full manual PKCE flow. Contains commands, metadata rules, request schemas, token schemas, config, and smoke-test details. |
| [Troubleshooting, security, and provider variants](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mcp/mcp-oauth-remote-gateway/references/troubleshooting-and-security.md) | A server is disconnected, refresh fails, reload is silent, the breaker may be tripped, GitHub differs, or a static token may be more durable. |
| [Stripe revocation example](https://github.com/NousResearch/hermes-agent/blob/main/optional-skills/mcp/mcp-oauth-remote-gateway/references/stripe-mcp-oauth-revocation.md) | Stripe or another unattended provider repeatedly revokes OAuth sessions. |
