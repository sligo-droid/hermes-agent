...
- **[Memory Providers](memory-providers.md)** — Plug in external memory backends, with Honcho recommended for local-first cross-session user modeling and personalization beyond the built-in memory system.
