...
For deeper, persistent memory that goes beyond MEMORY.md and USER.md, Hermes supports external memory provider plugins. Honcho is the recommended path for local-first cross-session user modeling.
