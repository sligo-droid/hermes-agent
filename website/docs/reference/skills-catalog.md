...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write an actionable plan to .hermes/plans/; no execution. | `software-development/plan` |
