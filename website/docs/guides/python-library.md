...
| `max_iterations` | `int` | `1000` | Max tool-calling iterations per conversation |
...
- **Iteration limits**: The default `max_iterations=1000` supports long-running coding tasks. For simple Q&A use cases, consider lowering it (e.g., `max_iterations=10`) to prevent runaway tool-calling loops and control costs.
:::
