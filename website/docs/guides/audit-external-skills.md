...
3. Review `critical` and `high` findings before installing anything.
4. Install only the specific skills you want with `hermes skills install`.
5. Prefer a small first import over a full pack import.
