...
const BUILTIN_ROUTES_CORE: Record<string, ComponentType> = {
  ...
  "/sligo/completed": CommandCenterPage,
  "/sligo/rejected": () => <RootRedirect to="/sligo/completed" />,
...
const HERMES_HOST_REDIRECT_ROUTES: Record<string, ComponentType> = {
  ...
  "/sligo/completed": HermesToSligoRedirect,
  ...
  const pluginTabMeta = useMemo(
    () => {
      const commandCenterTabs = [
        ...
        { path: "/sligo/completed", label: "Completed" },
