...
def run_codex_app_server_turn(
    ...
    *,
    ...
    def _ensure_codex_session() -> None:
        ...
        def _combined_codex_event(note: dict) -> None:
            _codex_event_activity(note)
            event_bridge(note)
        ...
        agent._codex_session = CodexAppServerSession(
            ...
            on_event=_combined_codex_event,
        )
    ...
    # App-server usage arrives on separate token-usage notifications rather
    # than the terminal turn event. Feed it into the same session accounting
    # and compression-adjudication paths as the default runtime.
