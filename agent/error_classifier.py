...
def classify_api_error(
    ...
    *,
    ...
    # Anthropic thinking block recovery (400). Signature mismatches and
    # frozen latest-assistant thinking blocks use the same recovery: strip the
    # replayed reasoning details and retry without mutating signed content.
    # Don't gate on provider because OpenRouter proxies these errors.
    if (
        status_code == 400
