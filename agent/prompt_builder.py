...
KANBAN_GUIDANCE = (
    ...
    "syntax/unit check plus one rendered visual/browser check, then PR/deploy only "
    "when the repo workflow requires it.\n"
    ...
    "blocker — don't claim done. Never put secrets/PII in summary or metadata. "
