...
- [x] Tightened completed Discord worker-board terminal summaries: merged PRs are inferred from PR state/merge evidence, recovered reviewer verdict metadata is surfaced, stale summary sidecars are rebuilt on terminal-board views, and concise outcomes are included in the terminal block.
