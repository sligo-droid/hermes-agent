...
TIPS = [
    ...
    "hermes chat --max-turns 200 overrides the default 1000-iteration limit per turn.",
    ...
    "Honcho is the recommended external memory provider for local-first setups.",
    ...
    '/indicator kaomoji|emoji|unicode|ascii picks the CLI busy-indicator style shown during agent runs.',
