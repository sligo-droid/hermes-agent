...
# Static fallback for Qwen Portal when live model discovery is unavailable.
# This used to live in ``hermes_cli.main`` beside the flow; keep it with the
# extracted implementation so the god-file split does not leave a stale import.
