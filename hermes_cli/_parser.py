...
Examples:
    ...
    hermes discord trace URL      Inspect a Discord permalink through native tools
...
def build_top_level_parser():
    ...
    chat_parser.add_argument(
        ...
        default=None,
        metavar="N",
        help="Maximum tool-calling iterations per conversation turn (default: 1000, or agent.max_turns in config)",
    )
    _inherited_flag(
        chat_parser,
        "--yolo",
